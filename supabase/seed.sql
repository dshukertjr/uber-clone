...
insert into public.drivers (id, model, number, location, is_available) 
    values 
        ('3ac03221-ad55-4eea-aa3b-3828335d0d5a', 'Toyota Corolla', 'ABC-123', ST_GeographyFromText('SRID=4326;POINT(-122.0841 37.4218983)'), false)
    , ('51d89275-8825-4a82-bba1-f246f595f5e9', 'Honda Civic', 'DEF-456', ST_GeographyFromText('SRID=4326;POINT(-122.083 37.4229983)'), true)
